...
import org.jetbrains.kotlin.asJava.elements.KtLightFieldForDeclarationSupport
...
class FakeJvmFieldConstantInspection : AbstractKotlinInspection() {
    ...
    private fun checkExpression(
        ...
        val resolvedLightField = (valueExpression as? PsiReference)?.resolve() as? KtLightFieldForDeclarationSupport
            ?: return
